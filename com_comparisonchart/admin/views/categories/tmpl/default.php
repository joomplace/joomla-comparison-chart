...
<form action="<?php echo JRoute::_('index.php?option=com_categories&view=categories'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="j-main-container"<?php echo !empty($this->sidebar) ? ' class="span10"' : ''; ?>>
		<div id="filter-bar" class="btn-toolbar">
			<div class="filter-search btn-group pull-left">
				...
				<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('JSEARCH_FILTER'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" class="hasTooltip" title="<?php echo JText::_('COM_CATEGORIES_ITEMS_SEARCH_FILTER'); ?>" />
			</div>
 ...
 <?php echo JText::_('COM_COMPARISONCHART_CATEGORY_CREATE_NEW1'); ?> <a onclick="javascript:Joomla.submitbutton('category.add')" href="javascript:void(0)"><?php echo JText::_('COM_COMPARISONCHART_CREATE_NEW_ONE'); ?></a>
                                    </td>
                                </tr>
                            <?php } ?>
			</tbody>
