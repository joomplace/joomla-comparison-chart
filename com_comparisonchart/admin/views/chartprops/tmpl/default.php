...
$chart_id = JRequest::getVar('filter_chart', 0, 'get', 'int');
...
$saveOrder = $listOrder == 'i.ordering';
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_comparisonchart&task=chartprop.saveOrderAjax&tmpl=component';
...
<div class="parent-wrap">
    ...
    <form
        action="<?php echo JRoute::_('index.php?option=com_comparisonchart&view=chartprops&filter_chart=' . intval($chart_id)); ?>"
        method="post"
                    ...
                    <table class="adminlist table table-striped" id="itemsList">
                        ...
                        <tr>
                            ...
                            <th width="15%" class="title">
                                <?php echo JHtml::_('grid.sort', 'JGLOBAL_TITLE', 'i.name', $listDirn, $listOrder); ?>
                            </th>
                            <th width="15%" class="title">
                                <?php echo JHtml::_('grid.sort', 'JSTATUS', 'i.published', $listDirn, $listOrder); ?>
                            </th>
                            <th width="15%" class="title">
                                <?php echo JHtml::_('grid.sort', 'COM_COMPARISONCHART_FIELD_ROW_TYPE', 'i.type', $listDirn, $listOrder); ?>
                            </th>
                        </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr class="row<?php echo $i % 2; ?>" sortable-group-id="1"
                                    ...
                                    <td class="title">
                                        <?php if ($this->canDo->get('core.edit')) { ?>
                                            <a href="<?php echo JRoute::_('index.php?option=com_comparisonchart&task=chartprop.edit&id=' . $item->id); ?>">
                                ...
                                <tr>
                                    <td colspan="6" style='text-align:center !important;'>
                                        <?php echo JText::_('COM_COMPARISONCHART_ITEMS_CREATE_NEW1'); ?> <a
                                            onclick="javascript:Joomla.submitbutton('chartprop.add')"
