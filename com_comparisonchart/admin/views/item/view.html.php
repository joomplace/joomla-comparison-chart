...
class ComparisonchartViewItem extends JViewLegacy {
    ...
    protected function addToolBar() {
        ...
        JToolBarHelper::title($this->isNew ? JText::_('COM_COMPARISONCHART_ITEM_CREATING') : JText::_('COM_COMPARISONCHART_ITEM_EDITING'), 'items');
